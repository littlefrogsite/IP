...
switch($mode)
{
  ...
  case "2":if($pic=="Chtholly"){$im = imagecreatefromjpeg("qmd_Chtholly.jpg");}else if($pic=="Pipi"){$im = imagecreatefromjpeg("qmd_pipi.jpg");}else {$im = imagecreatefromjpeg("qmd.jpg");}break;
